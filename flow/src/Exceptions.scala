...
/** Provides the ability to cope with errors, either Throwable or a String message,
  * by converting to an error type `E` that can be stored and passed as a disfavored
  * branch in `Or` or `Either` or whatever.
  */
trait Cope[E] {
...
object Cope {
  ...
  object From {
    def apply[F, E](f: F => E)(using cope: Cope[F]): Cope.From[F, E] = new Cope.From[F, E] {
